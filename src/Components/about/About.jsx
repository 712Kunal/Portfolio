...
function About() {
  ...
  return (
    <div className="outer-container max-w-[1366px] h-full flex flex-wrap justify-center items-center overflow-hidden">
      ...
      >
        <img
          className="w-full h-full rounded-3xl hover:grayscale cursor-pointer shadow-md shadow-cyan-200"
          src={mineportrait}
          alt="aboutImage"
        />
      </motion.div>
      ...
      <div className="edu-work w-1/2 flex flex-col flex-wrap gap-2">
        <div className="edu flex gap-5 relative -top-5">
          ...
          >
            ...
            <p className="text-[1.2rem]">
              Currently in Third Year pursuing B.E in Computer Engineering, at
              SPPU
            </p>
          </motion.div>
        ...
        {mobilewidth ? (
          <motion.p
            ...
            whileInView="animate"
          >
            I'm Kunal Jadhav, a Computer Engineering student passionate about
            technology and software development. I'm proficient in core
            languages like C, C++ and JavaScript. I specialize in creating
            dynamic user interfaces using HTML, CSS, and JavaScript. Recently, I
            have expanded my skill set to include React.js, also familiar with
            Tailwind CSS and SCSS for frontend development. Dedicated to
            becoming a Full-Stack developer. I'm also more dedicated to
            real-life problem-solving aspects and many more...
          </motion.p>
        ) : (
          <motion.p
            className="aboutpara text-xl tracking-widest font-mono"
            variants={textVariants}
            initial="initial"
            whileInView="animate"
          >
