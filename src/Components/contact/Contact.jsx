        ...
        <motion.div ref={ref} className='contact' variants={variants} initial="initial" whileInView="animate">
            ...
            <div className="formContainer">
                <motion.div className="phoneSvg" initial={{ opacity: 1 }} whileInView={{ opacity: 0 }} transition={{ delay: 3, duration: 1 }}>
                    <svg width="450px" height="450px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                        <motion.path
                            ...
                            strokeWidth={0.2} d="M14 2C14 2 16.2 2.2 19 5C21.8 7.8 22 10 22 10" stroke="#f6f93e"></motion.path> <path d="M14.207 5.53564C14.207 5.53564 15.197 5.81849 16.6819 7.30341C18.1668 8.78834 18.4497 9.77829 18.4497 9.77829" stroke="#f6f93e" ></path>
                        <path d="M10.0376 5.31617L10.6866 6.4791C11.2723 7.52858 11.0372
                ...
                <motion.form
                    ...
                    {success && <p className='text-xl text-green-400'>Your message has been sent successfully !!</p>}
                    {error && <p className='text-xs text-red-400'>Failed to send the message. Please try again later</p>}
                </motion.form>
            </div>
        </motion.div>
    )
