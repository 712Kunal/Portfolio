...
function Skills() {
  ...
  const getBoxVariant1 = (isMobile) => ({
    ...
    animate: {
      ...
      opacity: 1,
      boxShadow: isMobile
        ? "0px 0px 50px magenta"
        : "0px 0px 100px magenta, 0px 0px 100px #7209b7",
      transition: {
        x: {
  ...
  const boxVariant2 = {
    ...
    animate: {
      ...
      boxShadow: isMobile
        ? "0px 0px 50px cyan"
        : "0px 0px 100px magenta, 0px 0px 100px cyan",
      transition: {
        x: {
          duration: isMobile ? 1 : 2,
          type: "spring",
  ...
  return (
    <div className="Skills-container">
      <h1>
        <motion.p variants={textVariant} whileHover="animate">
          Explore My
        </motion.p>
